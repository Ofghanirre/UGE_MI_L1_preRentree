...
\def\titre{Session 2: Fondamentaux informatique pour bien démarrer les cours}
...
%Mais, étant donné que vous n'êtes pas encore des professionnels, autant choisir un assistant éditeur ``intelligent'' qui soit ... comment dire ... moins ``intelligent'' que vous :-) 
